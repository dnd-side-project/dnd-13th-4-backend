...
import com.example.wini.domain.notification.service.NotificationTokenService;
...
public class NotificationTokenController {
    ...
    public void saveNotificationToken(
            // TODO: 사용자 정보
            @Valid @RequestBody NotificationTokenSaveRequest request) {
        notificationTokenService.saveNotificationToken(MEMBER_ID, request);
    }
}
